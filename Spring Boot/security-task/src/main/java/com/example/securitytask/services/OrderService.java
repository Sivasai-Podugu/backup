...
import com.example.securitytask.repositories.OrderRepository;
import com.example.securitytask.specifications.JoinCriteria;
import com.example.securitytask.specifications.JoinTypes;
import com.example.securitytask.specifications.OrderSpecificationBuilder;
...
public class OrderService {
    ...
    public List<Orders> getOrdersForCustomer(User user) {
    ...
    public List<Orders> getOrdersBySpecification(String search) {
//        JoinCriteria joinCriteria = parseJoinParam(join);
        ...
        while (matcher.find()) {
            ...
            builder = (OrderSpecificationBuilder) builder.with(matcher.group(1), matcher.group(2), matcher.group(4), matcher.group(3), matcher.group(5),"user");
        }
